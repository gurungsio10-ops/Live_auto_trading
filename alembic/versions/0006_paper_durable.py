"""Ensure durable ops tables exist (idempotent for mixed environments).

Revision ID: 0006_paper_durable
Revises: 0005_durable_ops
"""
...
down_revision: Union[str, None] = "0005_durable_ops"
...
def upgrade() -> None:
    # Some environments stamped 0006 before 0005 ran; create missing tables.
